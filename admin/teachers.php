                            ...
                            <div class="col-md-12 mb-4 d-flex flex-wrap justify-content-between align-items-center">
                                ...
                                <form action="" method="GET" class="d-flex">
                                    ...
                                    <?php if (isset($_GET['search'])): ?>
                                        <a href="teachers.php" class="btn btn-danger"><i class="bi bi-x"></i></a>
                                    <?php endif; ?>
                                </form>
                            </div>
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        if (isset($_GET['search'])) {
                                            $search = $_GET['search'];
                                            $query = "SELECT teachers.id AS teacher_id, teachers.*, users.* FROM teachers JOIN users ON teachers.user_id = users.id WHERE users.name LIKE '%$search%' OR users.email LIKE '%$search%' OR users.mobile LIKE '%$search%'";
                                        } else {
